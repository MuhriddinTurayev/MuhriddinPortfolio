            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex mb-2 bg-success "
                            style="background-color: green; width: 135px;  border-radius: 5px;">

                            <a style="margin-left: 15px; color: white!important;text-decoration: none!important"
                    ...
                    <div class="mb-5">
                        <img class="img-fluid rounded w-100 mb-4" src="{{ asset('storage/' . $post->photos) }}"
                            alt="Image">
                        <p>{{ $post->content }}</p>
                    ...
                    <div class="mb-5">
                        <h3 class="mb-4 section-title">{{ count($post->comments) }} Izohlar</h3>
